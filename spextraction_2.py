...
def spextraction_images(format_file, data_list, map_save_location, wavelength_keyword='OSF', plot_maps=0, map_load=0, IF_scale=0, meancm_path='/prvt/ilio/EZDisturbance/haze/'):
    ...
    for i_wavel in range(0,len(wavel_spxs)):
        ...
        error_estimate[0,i_wavel] = np.std(spxs[40:100,40:100])
...
def IF_plotter(wavelengths_sorted,extracted_spectrum_ave,IF_plot_save_location):
    ...
    plt.fill_between(wavelengths_sorted,                     extracted_spectrum_ave[1]+extracted_spectrum_ave[1]*0.15,                     extracted_spectrum_ave[1]-extracted_spectrum_ave[1]*0.15,color='red',alpha=0.2)
    plt.fill_between(wavelengths_sorted,                     extracted_spectrum_ave[0]-extracted_spectrum_ave[0]*0.15,                     extracted_spectrum_ave[0]+extracted_spectrum_ave[0]*0.15,color='blue',alpha=0.2)
...
# spectrum_file_maker('/Users/emmadahl/Desktop/spextraction/spextraction_input_binned_lat.txt', '/Users/emmadahl/Desktop/spextraction/irtf_data_march_2019/2019jun1/input_list', '/Users/emmadahl/Desktop/spextraction/test_maps/', '/Users/emmadahl/Desktop/irtf_dps_retrieval/jupiter.spx', , '/Users/emmadahl/Desktop/spextraction/kurucz_HST_IRTF.dat', wavelength_keyword='OSF', plot_maps=1, map_load=0, IF_scale=1, file_format='Nemesis')
